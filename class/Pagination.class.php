...
class Pagination{ 
    ...
    var $numLinks       =  3; 
    var $currentPage    =  0; 
    var $firstLink      = '&lsaquo; Prva stranica'; 
    var $nextLink       = 'Sledeca &raquo;'; 
    var $prevLink       = '&laquo; Prethodna'; 
    var $lastLink       = 'Poslednja &rsaquo;'; 
    ...
    function createLinks(){  
        ...
        if ($numPages == 1){ 
            if ($this->showCount){ 
                $info = '<p>Prikaza : ' . $this->totalRows.'</p>'; 
                return $info; 
            }else{ 
                return ''; 
            } 
        ...
        if ($this->showCount){ 
           ...
           if( ($currentOffset + $this->perPage) < $this->totalRows) 
              ...
              $info .= $this->totalRows; 
            */
           #$info .= " od " . $this->totalRows . " | <ul class='pagination'>"; 
