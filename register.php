...
<div id="login" class="container">
    <div class="login-box">
        ...
        <form method="post">
            <div class="user-box">
                <input type="text" name="user" id="user" oninput="registerUser(this.value)" autocomplete="off" required>
                <label> Korisničko ime</label>
            </div>

            <div class="user-box">
                <input type="password" name="pass" id="pass" oninput="registerPass(this.value)" autocomplete="off" required>
                <label>Lozinka</label>
            </div>

            <div class="user-box">
                <input type="text" name="ime" id="ime" oninput="registerIme(this.value)" autocomplete="off" required>
                <label>Ime</label>
            </div>

            <div class="user-box">
                <input type="text" name="prezime" id="prezime" oninput="registerPrezime(this.value)" autocomplete="off" required>
                <label>Prezime</label>
            </div>

            <div class="user-box">
                <input type="text" name="email" id="email" oninput="registerEmail(this.value)" autocomplete="off" required>
                <label>E-mail</label>
            </div>

            <div class="user-box">
                <input type="tel" name="brTelefona" id="brTelefona" oninput="registerTelefon(this.value)" autocomplete="off" required>
                <label>Broj telefona</label>
            </div>

            <div class="user-box">
              <input type="text" name="adress" id="adress" oninput="registerAdress(this.value)" autocomplete="off" required>
              <label> Adresa </label>
          </div>

            <a class="btn__submit" id="linkRegister" href="#">
                <span></span>
                <span></span>
                <span></span>
                <span></span>
