...
--
-- Creation: Nov 03, 2022 at 12:07 PM
--
...
--
-- RELATIONSHIPS FOR TABLE `basket`:
--
...
--
-- Creation: Nov 02, 2022 at 08:43 AM
--
...
--
-- Creation: Dec 14, 2022 at 05:21 PM
--
...
--
-- Creation: Oct 27, 2022 at 01:38 PM
--
...
--
-- Creation: Nov 22, 2022 at 09:50 PM
--
...
--
-- RELATIONSHIPS FOR TABLE `user_product`:
--
...
--
DROP TRIGGER IF EXISTS `trig_basket`;
DELIMITER $$
...
--
DROP VIEW IF EXISTS `vwcategoryproduct`;
...
('root', 'kopriva', 'product', '{\"sorted_col\":\"`product`.`NAME_PRODUCT` DESC\"}', '2022-12-15 10:50:03');
...
--
-- Metadata for table user_product
--

--
-- Metadata for table vwcategoryproduct
--

--
-- Metadata for table vwforpay
--

--
-- Metadata for table vwordres
--

--
-- Metadata for database kopriva
--
COMMIT;
